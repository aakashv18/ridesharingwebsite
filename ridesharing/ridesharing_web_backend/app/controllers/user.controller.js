...
exports.userStatus = async (req, res) => {
  ...
  let user = await Documents.findOne({ user_id: req.params.id });
  if (!user) return responses.unauthorizedResponse(res, false);
  return responses.successResponse(res, true);
};
...
exports.insertRides = async (req, res) => {
  let new_ride = await new Ride({
    ...req.body,
  });
  new_ride.save();
};
